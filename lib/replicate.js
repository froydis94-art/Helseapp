...
// Max→Pro→Dev cascade can exceed 90s; keep under Vercel maxDuration (180s).
...
async function generateWithReplicate({
  ...
  console.info(
    `[replicate] Route: ${primaryLabel} first (${preferMax ? "demanding edit" : "mild edit"}; horizon=${horizon || "12w"})`
  );
