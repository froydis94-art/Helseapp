...
// Community models must be called with an explicit version ID via /v1/predictions.
...
function friendlyError(message) {
  ...
  if (isSafetyBlock(text)) {
    return [
      ...
      "Prøv bilde i t-skjorte/shorts — appen prøver reservedrift automatisk.",
    ].join(" ");
  }
    ...
    try {
      ...
      fallbackError.message = primaryWasSafety
        ? [
            ...
            "Tips: last opp bilde med t-skjorte/shorts.",
          ].join(" ")
        : friendlyError(
