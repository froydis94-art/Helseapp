...
const AGREEMENT_CATALOG: ReadonlyArray<AgreementVersion> = Object.freeze([
  ...
  Object.freeze({
    ...
    required: false,
    summary:
      "Optional, withdrawable consent for Personal Progress Library storage (via Private Progress Vault) and longitudinal comparison of body progress items.",
    fullDraft: [
      "HelseApp Sensitive Data Consent (draft)",
      "",
      "This separate consent covers optional storage and longitudinal comparison",
      "of body images and related sensitive progress data in your Personal Progress Library.",
      "The Private Progress Vault is the secure storage layer under the Library.",
      "It is not part of the Terms of Service.",
      "Consent is explicit, opt-in, and as easy to withdraw as it is to grant.",
      "Withdrawal may block future Library saves; deleting existing items is a separate informed choice.",
